...
use PortfolioBundle\Entity\Picture;
...
class PictureController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pictures = $em->getRepository('PortfolioBundle:Picture')->findAll();

        return $this->render('PortfolioBundle:picture:index.html.twig', array(
            'pictures' => $pictures,
        ));
    }
    ...
    {
        $picture = new Picture();
        $form = $this->createForm('PortfolioBundle\Form\PictureType', $picture);
        ...
        return $this->render('PortfolioBundle:picture:new.html.twig', array(
            'picture' => $picture,
    ...
    {
        $deleteForm = $this->createDeleteForm($picture);
        $editForm = $this->createForm('PortfolioBundle\Form\PictureType', $picture);
        ...
        return $this->render('PortfolioBundle:picture:edit.html.twig', array(
            'picture' => $picture,
